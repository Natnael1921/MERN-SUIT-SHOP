      ...
      <nav className={`nav-bar ${isAdmin ? "admin-nav" : ""}`}>
        {!isAdmin && (
          <>
            ...
            {/* Desktop links only for users/guests */}
            {!isMobile && (
          ...
          <div className="sidebar-contents">
            ...
            {isAdmin ? (
              <>
                ...
                <NavLink to="/manage-cloths" onClick={closeMenu}>
                  Manage Cloths
                </NavLink>
                <NavLink to="/orders-in" onClick={closeMenu}>
                  Orders In
                </NavLink>
                <NavLink to="/dashboard" onClick={closeMenu}>
                  Users
              ...
              <>
                <NavLink to="/cloths" onClick={closeMenu}>
                  Cloths
                </NavLink>
